...
from scripts.precheck_fragment import check_seed_phrase_format
...
class TestSeedPhraseValidation:
    ...
    def test_seed_phrase_format(self, seed_phrase, expected):
        ...
        with patch("scripts.precheck_fragment.Path.exists", return_value=True), \
...
def test_seed_phrase_check_with_missing_env():
    ...
    with patch("scripts.precheck_fragment.Path.exists", return_value=False):
